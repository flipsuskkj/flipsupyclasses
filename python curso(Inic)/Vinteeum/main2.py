    ...
    def distribuir(self, numero):
        ...
        for x in range(numero):
            if len(self.cartas) > 0:
                carta_obj = self.cartas.pop()
                cartas_dadas.append(carta_obj)
...
class mão():
    ...
    def mostrar(self, mostrar_cartas_dealer=False):
        ...
        for index, carta in enumerate(self.cartas):
            ...
            if index == 0 and self.dealer and not mostrar_cartas_dealer and not self.vinteeum():
                print('Escondido')
            else:
                print(carta)
...
class Jogo:
    ...
    def check_venc(self, player_hand, dealer_hand, gameover=False):
        ...
        if not gameover:
            ...
            elif player_hand.vinteeum() and dealer_hand.vinteeum():
                print('Os Dois Fizeram 21, EMPATE!!!!')
                return True

            if player_hand.vinteeum():
                print('Vinte e um, Você venceu!!!')
                return True

            if dealer_hand.vinteeum():
                print('Vinte e um, Dealer venceu!!!')
                return True
